...
CREATE TABLE IF NOT EXISTS public.menu_permissions (
    ...
    CONSTRAINT menu_permissions_user_id_fkey FOREIGN KEY (user_id) REFERENCES auth.users (id) ON DELETE CASCADE,
...
-- Allow authenticated users to read and manage their own permissions
